pipeline {
	    agent any
	        ...
	        UIPATH_ORCH_LOGICAL_NAME = "inceneditkvy"
	        UIPATH_ORCH_TENANT_NAME = "StanTenant"
	        UIPATH_ORCH_FOLDER_NAME = "OrchestratorTest"
	    }
	    ...
	    stages {
	        ...
	        stage('Perform Tests') {
	            steps {
					...
					UiPathTest (
					  testTarget: [$class: 'TestSetEntry', testSet: "CICDTEST2"],
					  orchestratorAddress: "${UIPATH_ORCH_URL}",
					  orchestratorTenant: "${UIPATH_ORCH_TENANT_NAME}",
					  folderName: "${UIPATH_ORCH_FOLDER_NAME}",
					  timeout: 10000,
